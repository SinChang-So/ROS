...
/*void send_ASCLIN_UART_message(float32 sonar)
{
    float32 g_tx_sonar_Data[] = sonar;
    Ifx_SizeT g_sonar_count = sizeof(g_tx_sonar_Data);
    IfxAsclin_Asc_write(&g_ascHandle, g_txData, &g_sonar_count, TIME_INFINITE);
}*/
